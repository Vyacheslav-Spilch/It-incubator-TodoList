import { addTaskAC, changeTaskStatusAC, changeTaskTitleAC, deleteTasksAC, tasksReducer } from './tasks-reducer'
...
test('correct task should be deleted from correct array', () => {
    ...
    const action = deleteTasksAC('2', 'todolistId2')
...
test('changing the title of the selected task', () => {
    startState = {
        'todolistId1': [
            {id: '1', title: 'CSS', isDone: false},
            {id: '2', title: 'JS', isDone: true},
    ...
    const action = changeTaskTitleAC('todolistId1', '3', 'TypeScript')
    const endState = tasksReducer(startState, action)
...
let startTodolistState: TodoListsType[]
